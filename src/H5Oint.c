...
H5O_create_id(H5F_t *f, size_t size_hint, size_t initial_rc, hid_t ocpl_id, H5O_loc_t *loc /*out*/)
{
    ...
    if (H5O_create(f, size_hint, initial_rc, oc_plist, loc) < 0)
 ...
 */
herr_t
H5O_create(H5F_t *f, size_t size_hint, size_t initial_rc, H5P_genplist_t *oc_plist, H5O_loc_t *loc /*out*/)
{
    H5O_t *oh        = NULL;
    herr_t ret_value = SUCCEED;
...
H5O_create_ohdr(H5F_t *f, H5P_genplist_t *oc_plist)
{
    ...
    if (H5P_PLIST_IS_DEFAULT(oc_plist)) {
