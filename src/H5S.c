...
/* Dataspace ID class */
static H5I_class_t H5I_DATASPACE_CLS[1] = {{
...
static H5I_class_t H5I_SPACE_SEL_ITER_CLS[1] = {{
...
H5Sencode2(hid_t obj_id, void *buf, size_t *nalloc, hid_t fapl_id)
{
    ...
    if (H5CX_set_apl(fapl, H5I_INVALID_HID, true) < 0)
        HGOTO_ERROR(H5E_DATASPACE, H5E_CANTSET, FAIL, "can't set access property list info");
