...
static herr_t H5L__create_soft_api_common(const char *link_target, hid_t link_loc_id, const char *link_name, H5P_genplist_t *lcpl, H5P_genplist_t *lapl, void **token_ptr, H5VL_object_t **_vol_obj_ptr);
static herr_t H5L__create_hard_api_common(hid_t cur_loc_id, const char *cur_name, hid_t new_loc_id, const char *new_name, H5P_genplist_t *lcpl, H5P_genplist_t *lapl, void **token_ptr, H5VL_connector_t **conn);
static herr_t H5L__delete_api_common(hid_t loc_id, const char *name, H5P_genplist_t *lapl, void **token_ptr, H5VL_object_t **_vol_obj_ptr);
static herr_t H5L__delete_by_idx_api_common(hid_t loc_id, const char *group_name, H5_index_t idx_type, H5_iter_order_t order, hsize_t n, H5P_genplist_t *lapl, void **token_ptr, H5VL_object_t **_vol_obj_ptr);
static herr_t H5L__exists_api_common(hid_t loc_id, const char *name, bool *exists, H5P_genplist_t *lapl, void **token_ptr, H5VL_object_t **_vol_obj_ptr);
static herr_t H5L__iterate_api_common(hid_t group_id, H5_index_t idx_type, H5_iter_order_t order, hsize_t *idx_p, H5L_iterate2_t op, void *op_data, void **token_ptr, H5VL_object_t **_vol_obj_ptr);
        ...
        hid_t lapl_id)
{
    ...
    /* Move the link */
    if (H5VL_link_move(vol_obj1, &loc_params1, vol_obj2, &loc_params2, lcpl, lapl, H5_REQUEST_NULL) < 0)
        ...
        hid_t lapl_id)
{
    ...
    /* Copy the link */
    if (H5VL_link_copy(vol_obj1, &loc_params1, vol_obj2, &loc_params2, lcpl, lapl, H5_REQUEST_NULL) < 0)
 ...
 */
static herr_t
H5L__create_soft_api_common(const char *link_target, hid_t link_loc_id, const char *link_name, H5P_genplist_t *lcpl, H5P_genplist_t *lapl, void **token_ptr, H5VL_object_t **_vol_obj_ptr)
{
    ...
    if (H5VL_setup_name_args(link_loc_id, link_name, true, lapl, vol_obj_ptr, &loc_params) < 0)
    ...
    /* Create the link */
    if (H5VL_link_create(&vol_cb_args, *vol_obj_ptr, &loc_params, lcpl, lapl, token_ptr) < 0)
               ...
               hid_t lapl_id)
{
    ...
    if (H5L__create_soft_api_common(link_target, link_loc_id, link_name, lcpl, lapl, NULL, NULL) < 0)
                     ...
                     hid_t link_loc_id, const char *link_name, hid_t lcpl_id, hid_t lapl_id, hid_t es_id)
{
    ...
    if (H5L__create_soft_api_common(link_target, link_loc_id, link_name, lcpl, lapl, token_ptr, &vol_obj) < 0)
 ...
 */
static herr_t
H5L__create_hard_api_common(hid_t cur_loc_id, const char *cur_name, hid_t link_loc_id, const char *link_name, H5P_genplist_t *lcpl, H5P_genplist_t *lapl, void **token_ptr, H5VL_connector_t **connector)
{
    ...
    /* Create the link */
    if (H5VL_link_create(&vol_cb_args, (link_vol_obj ? link_vol_obj : curr_vol_obj), &link_loc_params, lcpl, lapl, token_ptr) < 0)
               ...
               hid_t lapl_id)
{
    ...
    if (H5L__create_hard_api_common(cur_loc_id, cur_name, new_loc_id, new_name, lcpl, lapl, NULL, NULL) < 0)
                   ...
                   hid_t lcpl_id, hid_t lapl_id)
{
    ...
    *p++ = (H5L_EXT_VERSION << 4) | H5L_EXT_FLAGS_ALL; /* External link version & flags */
    ...
    if (H5VL_link_create(&vol_cb_args, vol_obj, &loc_params, lcpl, lapl, H5_REQUEST_NULL) < 0)
 ...
 */
static herr_t
H5L__delete_api_common(hid_t loc_id, const char *name, H5P_genplist_t *lapl, void **token_ptr, H5VL_object_t **_vol_obj_ptr)
{
    H5VL_object_t  *tmp_vol_obj = NULL; /* Object for loc_id */
    H5VL_object_t **vol_obj_ptr =
        (_vol_obj_ptr ? _vol_obj_ptr : &tmp_vol_obj); /* Ptr to object ptr for loc_id */
    ...
    /* Set up object access arguments */
    if (H5VL_setup_name_args(loc_id, name, true, lapl, vol_obj_ptr, &loc_params) < 0)
        HGOTO_ERROR(H5E_LINK, H5E_CANTSET, FAIL, "can't set object access arguments");
    ...
    /* Delete link */
    if (H5VL_link_specific(*vol_obj_ptr, &loc_params, &vol_cb_args, token_ptr) < 0)
...
H5Ldelete(hid_t loc_id, const char *name, hid_t lapl_id)
{
    ...
    if (H5L__delete_api_common(loc_id, name, lapl, NULL, NULL) < 0)
                ...
                hid_t lapl_id, hid_t es_id)
{
    ...
    if (H5L__delete_api_common(loc_id, name, lapl, token_ptr, &vol_obj) < 0)
 ...
 */
static herr_t
H5L__delete_by_idx_api_common(hid_t loc_id, const char *group_name, H5_index_t idx_type, H5_iter_order_t order, hsize_t n, H5P_genplist_t *lapl, void **token_ptr, H5VL_object_t **_vol_obj_ptr)
{
    H5VL_object_t  *tmp_vol_obj = NULL; /* Object for loc_id */
    H5VL_object_t **vol_obj_ptr =
        (_vol_obj_ptr ? _vol_obj_ptr : &tmp_vol_obj); /* Ptr to object ptr for loc_id */
    ...
    /* Set up object access arguments */
    if (H5VL_setup_idx_args(loc_id, group_name, idx_type, order, n, true, lapl, vol_obj_ptr, &loc_params) < 0)
        HGOTO_ERROR(H5E_LINK, H5E_CANTSET, FAIL, "can't set object access arguments");
                 ...
                 hid_t lapl_id)
{
    ...
    /* Delete a link synchronously */
    if (H5L__delete_by_idx_api_common(loc_id, group_name, idx_type, order, n, lapl, NULL, NULL) < 0)
        HGOTO_ERROR(H5E_LINK, H5E_CANTDELETE, FAIL, "unable to synchronously delete link");
                       ...
                       hid_t lapl_id, hid_t es_id)
{
    ...
    /* Delete a link asynchronously */
    if (H5L__delete_by_idx_api_common(loc_id, group_name, idx_type, order, n, lapl, token_ptr, &vol_obj) < 0)
        HGOTO_ERROR(H5E_LINK, H5E_CANTDELETE, FAIL, "unable to asynchronously delete link");
 ...
 *--------------------------------------------------------------------------*/
static herr_t
H5L__exists_api_common(hid_t loc_id, const char *name, bool *exists, H5P_genplist_t *lapl, void **token_ptr, H5VL_object_t **_vol_obj_ptr)
{
    H5VL_object_t  *tmp_vol_obj = NULL; /* Object for loc_id */
    H5VL_object_t **vol_obj_ptr =
        (_vol_obj_ptr ? _vol_obj_ptr : &tmp_vol_obj); /* Ptr to object ptr for loc_id */
    ...
    /* Set up object access arguments */
    if (H5VL_setup_name_args(loc_id, name, false, lapl, vol_obj_ptr, &loc_params) < 0)
        HGOTO_ERROR(H5E_LINK, H5E_CANTSET, FAIL, "can't set object access arguments");
...
H5Lexists(hid_t loc_id, const char *name, hid_t lapl_id)
{
    ...
    exists = false;
    if (H5L__exists_api_common(loc_id, name, &exists, lapl, NULL, NULL) < 0)
                ...
                hbool_t *exists, hid_t lapl_id, hid_t es_id)
{
    ...
    if (H5L__exists_api_common(loc_id, name, exists, lapl, token_ptr, &vol_obj) < 0)
 ...
 */
static herr_t
H5L__iterate_api_common(hid_t group_id, H5_index_t idx_type, H5_iter_order_t order, hsize_t *idx_p, H5L_iterate2_t op, void *op_data, void **token_ptr, H5VL_object_t **_vol_obj_ptr)
{
    H5VL_object_t  *tmp_vol_obj = NULL; /* Object for loc_id */
    H5VL_object_t **vol_obj_ptr =
        (_vol_obj_ptr ? _vol_obj_ptr : &tmp_vol_obj);   /* Ptr to object ptr for loc_id */
    ...
    if ((ret_value = H5VL_link_specific(*vol_obj_ptr, &loc_params, &vol_cb_args, token_ptr)) < 0)
