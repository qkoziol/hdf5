        ...
        hid_t lapl_id)
{
    ...
    if (H5CX_set_lcpl(lcpl) < 0)
        HGOTO_ERROR(H5E_LINK, H5E_CANTSET, FAIL, "can't set link creation property list info");

    /* Verify access property list and set up collective metadata if appropriate */
    if (H5CX_set_apl(lapl, dst_loc_id, true) < 0)
    ...
    loc_params1.loc_data.loc_by_name.lapl_id = H5P_PLIST_ID(lapl);
    ...
    loc_params2.loc_data.loc_by_name.lapl_id = H5P_PLIST_ID(lapl);
        ...
        hid_t lapl_id)
{
    ...
    /* Verify access property list and set up collective metadata if appropriate */
    if (H5CX_set_apl(lapl, ((src_loc_id != H5L_SAME_LOC) ? src_loc_id : dst_loc_id), true) < 0)
        HGOTO_ERROR(H5E_LINK, H5E_CANTSET, FAIL, "can't set access property list info");
                            ...
                            H5VL_object_t **_vol_obj_ptr)
{
    ...
    /* Verify access property list and set up collective metadata if appropriate */
    if (H5CX_set_apl(lapl, link_loc_id, true) < 0)
        HGOTO_ERROR(H5E_LINK, H5E_CANTSET, FAIL, "can't set access property list info");
                     ...
                     hid_t link_loc_id, const char *link_name, hid_t lcpl_id, hid_t lapl_id, hid_t es_id)
{
    ...
    if (NULL != token) {
        ...
        if (NULL == (es = H5I_object_verify(es_id, H5I_EVENTSET)))
            HGOTO_ERROR(H5E_LINK, H5E_BADTYPE, FAIL, "not an event set");
                            ...
                            H5VL_connector_t **connector)
{
    ...
    /* Verify access property list and set up collective metadata if appropriate */
    if (H5CX_set_apl(lapl, cur_loc_id, true) < 0)
        HGOTO_ERROR(H5E_LINK, H5E_CANTSET, FAIL, "can't set access property list info");
    ...
    link_loc_params.loc_data.loc_by_name.lapl_id = H5P_PLIST_ID(lapl);
    ...
    vol_cb_args.args.hard.curr_loc_params.loc_data.loc_by_name.lapl_id = H5P_PLIST_ID(lapl);
                     ...
                     hid_t lapl_id, hid_t es_id)
{
    ...
    if (NULL != token) {
        ...
        /* clang-format off */
        if (H5ES_insert(es, connector, token,
 ...
 */
static herr_t
H5L__delete_api_common(hid_t loc_id, const char *name, H5P_genplist_t *lapl, void **token_ptr,
                       H5VL_object_t **_vol_obj_ptr)
{
    H5VL_object_t  *tmp_vol_obj = NULL; /* Object for loc_id */
    H5VL_object_t **vol_obj_ptr =
                  ...
                  void *buf /*out*/, size_t size, hid_t lapl_id)
{
    ...
    loc_params.loc_data.loc_by_idx.lapl_id  = H5P_PLIST_ID(lapl);
    loc_params.obj_type                     = H5I_get_type(loc_id);
 ...
 *--------------------------------------------------------------------------*/
static herr_t
H5L__exists_api_common(hid_t loc_id, const char *name, bool *exists, H5P_genplist_t *lapl, void **token_ptr,
                       H5VL_object_t **_vol_obj_ptr)
{
    H5VL_object_t  *tmp_vol_obj = NULL; /* Object for loc_id */
    H5VL_object_t **vol_obj_ptr =
