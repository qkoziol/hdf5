...
H5_DLL herr_t H5T__commit_anon(H5F_t *file, H5T_t *type);
H5_DLL herr_t H5T__commit(H5F_t *file, H5T_t *type);
H5_DLL herr_t H5T__commit_named(const H5G_loc_t *loc, const char *name, H5T_t *dt, H5P_genplist_t *tcpl);
