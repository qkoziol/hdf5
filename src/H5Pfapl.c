 ...
 */
herr_t
H5Pset_mdc_log_options(hid_t fapl_id, bool is_enabled, const char *location, bool start_on_access)
{
    H5P_genplist_t *fapl = NULL;         /* Property list pointer */
 ...
 */
herr_t
H5Pget_mdc_log_options(hid_t fapl_id, bool *is_enabled /*out*/, char *location /*out*/,
 ...
 */
herr_t
H5Pset_all_coll_metadata_ops(hid_t apl_id, bool is_collective)
{
    ...
    /* Release resources */
    if (apl && H5P_release(apl, H5P_LOCK_EXCLUSIVE) < 0)
        HDONE_ERROR(H5E_PLIST, H5E_CANTUNLOCK, FAIL, "unable to unlock property list");
 ...
 */
herr_t
H5Pget_all_coll_metadata_ops(hid_t apl_id, bool *is_collective /*out*/)
{
    H5P_genplist_t *apl       = NULL;    /* Property list pointer */
    herr_t          ret_value = SUCCEED; /* return value */
    ...
    /* Release resources */
    if (apl && H5P_release(apl, H5P_LOCK_SHARED) < 0)
        HDONE_ERROR(H5E_PLIST, H5E_CANTUNLOCK, FAIL, "unable to unlock property list");
 ...
 */
herr_t
H5Pset_coll_metadata_write(hid_t fapl_id, bool is_collective)
{
    H5P_genplist_t *fapl      = NULL;    /* Property list pointer */
    herr_t          ret_value = SUCCEED; /* return value */
 ...
 */
herr_t
H5Pget_coll_metadata_write(hid_t fapl_id, bool *is_collective /*out*/)
{
    H5P_genplist_t *fapl      = NULL;    /* Property list pointer */
    herr_t          ret_value = SUCCEED; /* return value */
