...
H5_DLL herr_t H5Z_can_apply(const struct H5O_layout_t *layout, const struct H5O_pline_t *pline,
                            hid_t type_id);
H5_DLL herr_t H5Z_set_local(const struct H5O_layout_t *layout, const struct H5O_pline_t *pline,
                            hid_t type_id);
