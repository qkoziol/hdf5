...
H5_DLL herr_t H5Z_can_apply(H5P_genplist_t *dcpl, hid_t type_id);
H5_DLL herr_t H5Z_set_local(H5P_genplist_t *dcpl, hid_t type_id);
...
H5_DLL htri_t H5Z_ignore_filters(H5P_genplist_t *dcpl, const H5T_t *type, const H5S_t *space);
