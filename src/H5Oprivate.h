...
typedef struct H5O_storage_virtual_t {
    ...
    hsize_t printf_gap; /* Maximum number of sequential missing source datasets before terminating the search
                           for more */
    H5P_genplist_t *source_fapl; /* Cached FAPL to use to open source files */
    ...
    bool use_tree;              /* Whether the 'use spatial tree' flag was set in DAPL */
...
H5_DLL herr_t H5O_refresh_metadata_reopen(hid_t oid, H5P_genplist_t *apl, H5G_loc_t *obj_loc,
