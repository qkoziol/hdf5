...
H5_DLL herr_t H5O_create(H5F_t *f, size_t size_hint, size_t initial_rc, H5P_genplist_t *oc_plist, H5O_loc_t *loc /*out*/);
...
H5_DLL herr_t H5O_apply_ohdr(H5F_t *f, H5O_t *oh, H5P_genplist_t *ocpl_plist, size_t size_hint, size_t initial_rc,
                             H5O_loc_t *loc_out);
