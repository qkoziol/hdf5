...
typedef struct H5O_storage_virtual_t {
    ...
    H5P_genplist_t *source_dapl_plist; /* DAPL to use to open source datasets */
...
H5_DLL herr_t H5O_refresh_metadata_reopen(hid_t oid, H5P_genplist_t *apl_plist, H5G_loc_t *obj_loc,
