...
#ifndef H5FDonion_pkg_H
#define H5FDonion_pkg_H
...
/* Private headers */
#include "H5FDonion_private.h" /* Onion VFD             */
...
H5_DLL herr_t H5FD__onion_ingest_header(H5FD_onion_header_t *hdr_out, H5FD_int_t *raw_file, haddr_t addr);
H5_DLL herr_t H5FD__onion_write_header(H5FD_onion_header_t *header, H5FD_int_t *file);
...
H5_DLL herr_t H5FD__onion_ingest_history(H5FD_onion_history_t *history_out, H5FD_int_t *raw_file,
