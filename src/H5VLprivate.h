...
H5_DLL herr_t H5VL_setup_idx_args(hid_t loc_id, const char *name, H5_index_t idx_type, H5_iter_order_t order,
                                  hsize_t n, bool is_collective, H5P_genplist_t *lapl, H5VL_object_t **vol_obj,
...
H5_DLL void  *H5VL_file_open(H5VL_connector_t *connector, const char *name, unsigned flags, hid_t fapl_id,
                             hid_t dxpl_id, void **req);
