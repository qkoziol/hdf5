...
public class H5 implements java.io.Serializable {
     ...
     *            Error from the HDF5 Library.
     **/
    public static boolean H5FDcmp_driver_cls(long drvr_id1, long drvr_id2)
        throws HDF5LibraryException
    {
    ...
    private synchronized static native boolean _H5FDcmp_driver_cls(long drvr_id1, long drvr_id2)
        throws HDF5LibraryException;
