...
/* Types of various sizes, for array free lists */
typedef struct {
    unsigned char buf[1];
} h5fl_arr_test_type_1;

typedef struct {
    unsigned char buf[1];
} h5fl_arr_test_type_2;

typedef struct {
    unsigned char buf[1];
} h5fl_arr_test_type_3;
...
typedef struct {
    unsigned char buf[1];
} h5fl_arr_test_type_5;

typedef struct {
    unsigned char buf[1];
} h5fl_arr_test_type_6;

typedef struct {
    unsigned char buf[1];
} h5fl_arr_test_type_7;

typedef struct {
    unsigned char buf[1];
} h5fl_arr_test_type_8;

typedef struct {
    unsigned char buf[1];
} h5fl_arr_test_type_9;

typedef struct {
    unsigned char buf[1];
} h5fl_arr_test_type_10;

typedef struct {
    unsigned char buf[1];
} h5fl_arr_test_type_11;

typedef struct {
    unsigned char buf[1];
} h5fl_arr_test_type_12;
...
H5FL_ARR_DEFINE_STATIC(h5fl_arr_test_type_1, 16);
H5FL_ARR_DEFINE_STATIC(h5fl_arr_test_type_2, 64);
H5FL_ARR_DEFINE_STATIC(h5fl_arr_test_type_3, 256);
H5FL_ARR_DEFINE_STATIC(h5fl_arr_test_type_4, 2);
H5FL_ARR_DEFINE_STATIC(h5fl_arr_test_type_5, 3);
H5FL_ARR_DEFINE_STATIC(h5fl_arr_test_type_6, 5);
H5FL_ARR_DEFINE_STATIC(h5fl_arr_test_type_7, 8);
H5FL_ARR_DEFINE_STATIC(h5fl_arr_test_type_8, 13);
H5FL_ARR_DEFINE_STATIC(h5fl_arr_test_type_9, 21);
H5FL_ARR_DEFINE_STATIC(h5fl_arr_test_type_10, 34);
H5FL_ARR_DEFINE_STATIC(h5fl_arr_test_type_11, 55);
H5FL_ARR_DEFINE_STATIC(h5fl_arr_test_type_12, 89);
...
/* Array of all the 'array' free lists & info */
static h5fl_arr_type_info h5fl_arr_test_types[] = {
    {&H5FL_ARR_NAME(h5fl_arr_test_type_1), 16},  {&H5FL_ARR_NAME(h5fl_arr_test_type_2), 64},
    {&H5FL_ARR_NAME(h5fl_arr_test_type_3), 256}, {&H5FL_ARR_NAME(h5fl_arr_test_type_4), 2},
    {&H5FL_ARR_NAME(h5fl_arr_test_type_5), 3},   {&H5FL_ARR_NAME(h5fl_arr_test_type_6), 5},
    {&H5FL_ARR_NAME(h5fl_arr_test_type_7), 8},   {&H5FL_ARR_NAME(h5fl_arr_test_type_8), 13},
    {&H5FL_ARR_NAME(h5fl_arr_test_type_9), 21},  {&H5FL_ARR_NAME(h5fl_arr_test_type_10), 34},
    {&H5FL_ARR_NAME(h5fl_arr_test_type_11), 55}, {&H5FL_ARR_NAME(h5fl_arr_test_type_12), 89},
};
...
typedef union {
    unsigned             type_idx;
    h5fl_arr_test_token *token;
    unsigned             rng_size;
} h5fl_arr_test_op_param;
...
typedef struct {
    h5fl_arr_test_op_code  op_code;
    h5fl_arr_test_token   *token;
    h5fl_arr_test_op_param param;
} h5fl_arr_test_op;
...
typedef struct {
    unsigned          vec_size;
    h5fl_arr_test_op *op_vector;
} h5fl_arr_test_vector;
...
/* Operation odds when token array is not full */
/* (Must sum to 1000 (i.e. 100%) */
static const h5fl_arr_test_op_odds h5fl_arr_all_ops_odds[] = {
    {171, H5FL_ARR_OP_MALLOC},  /* 17.1%  = H5FL_ARR_OP_MALLOC */
    {171, H5FL_ARR_OP_CALLOC},  /* 17.1%  = H5FL_ARR_OP_CALLOC */
    {200, H5FL_ARR_OP_REALLOC}, /* 20.0%  = H5FL_ARR_OP_REALLOC */
    {64, H5FL_ARR_OP_ZERO},     /* 6.4% = H5FL_ARR_OP_ZERO */
    {64, H5FL_ARR_OP_FILL1},    /* 6.4% = H5FL_ARR_OP_FILL1 */
    {64, H5FL_ARR_OP_FILL2},    /* 6.4% = H5FL_ARR_OP_FILL2 */
    {64, H5FL_ARR_OP_FILL3},    /* 6.4% = H5FL_ARR_OP_FILL3 */
    {202, H5FL_ARR_OP_FREE},    /* 20.2%   = H5FL_ARR_OP_FREE */
};
...
/* Operation odds when token array is full */
/* (Must sum to 1000 (i.e. 100%) */
static const h5fl_arr_test_op_odds h5fl_arr_full_ops_odds[] = {
    {0, H5FL_ARR_OP_MALLOC},    /* 0%  = H5FL_ARR_OP_MALLOC */
    {0, H5FL_ARR_OP_CALLOC},    /* 0%  = H5FL_ARR_OP_CALLOC */
    {200, H5FL_ARR_OP_REALLOC}, /* 20.0%  = H5FL_ARR_OP_REALLOC */
    {84, H5FL_ARR_OP_ZERO},     /* 8.4% = H5FL_ARR_OP_ZERO */
    {84, H5FL_ARR_OP_FILL1},    /* 8.4% = H5FL_ARR_OP_FILL1 */
    {84, H5FL_ARR_OP_FILL2},    /* 8.4% = H5FL_ARR_OP_FILL2 */
    {84, H5FL_ARR_OP_FILL3},    /* 8.4% = H5FL_ARR_OP_FILL3 */
    {464, H5FL_ARR_OP_FREE},    /* 46.4% = H5FL_ARR_OP_FREE */
};
...
/* Operation odds when vector is nearly full */
/* (Must sum to 1000 (i.e. 100%) */
static const h5fl_arr_test_op_odds h5fl_arr_vec_almost_full_ops_odds[] = {
    {0, H5FL_ARR_OP_MALLOC},    /* 0%  = H5FL_ARR_OP_MALLOC */
    {0, H5FL_ARR_OP_CALLOC},    /* 0%  = H5FL_ARR_OP_CALLOC */
    {400, H5FL_ARR_OP_REALLOC}, /* 40%  = H5FL_ARR_OP_REALLOC */
    {150, H5FL_ARR_OP_ZERO},    /* 15% = H5FL_ARR_OP_ZERO */
    {150, H5FL_ARR_OP_FILL1},   /* 15% = H5FL_ARR_OP_FILL1 */
    {150, H5FL_ARR_OP_FILL2},   /* 15% = H5FL_ARR_OP_FILL2 */
    {150, H5FL_ARR_OP_FILL3},   /* 15% = H5FL_ARR_OP_FILL3 */
    {0, H5FL_ARR_OP_FREE},      /* 0% = H5FL_ARR_OP_FREE */
};
...
/* Operation odds when token array is empty */
/* (Must sum to 1000 (i.e. 100%) */
static const h5fl_arr_test_op_odds h5fl_arr_empty_ops_odds[] = {
    {500, H5FL_ARR_OP_MALLOC}, /* 50%  = H5FL_ARR_OP_MALLOC */
    {500, H5FL_ARR_OP_CALLOC}, /* 50%  = H5FL_ARR_OP_CALLOC */
    {0, H5FL_ARR_OP_REALLOC},  /* 0%  = H5FL_ARR_OP_REALLOC */
    {0, H5FL_ARR_OP_ZERO},     /* 0% = H5FL_ARR_OP_ZERO */
    {0, H5FL_ARR_OP_FILL1},    /* 0% = H5FL_ARR_OP_FILL1 */
    {0, H5FL_ARR_OP_FILL2},    /* 0% = H5FL_ARR_OP_FILL2 */
    {0, H5FL_ARR_OP_FILL3},    /* 0% = H5FL_ARR_OP_FILL3 */
    {0, H5FL_ARR_OP_FREE},     /* 0% = H5FL_ARR_OP_FREE */
};
...
static unsigned
get_new_h5fl_arr_token(h5fl_arr_test_token *tokens, unsigned *next_token)
{
    unsigned curr_pos  = *next_token;
    unsigned start_pos = curr_pos;
...
static h5fl_arr_test_op_code
get_new_h5fl_arr_op(const h5fl_arr_test_op_odds *op_odds)
{
    unsigned idx;
    unsigned rng;
...
static unsigned
get_active_h5fl_arr_token(h5fl_arr_test_token *tokens, unsigned num_possible_tokens)
{
    unsigned curr_pos;
    unsigned start_pos;
...
static void
init_h5fl_arr_vector(unsigned vec_size, h5fl_arr_test_vector *vector, unsigned num_tokens,
                     h5fl_arr_test_token *tokens)
{
    unsigned num_active_tokens = 0; /* # of active tokens at any position in the test vector execution */
    unsigned curr_alloc_token;      /* Current position for allocating tokens */
    unsigned pos;                   /* Current position in the test vector */
    ...
    /* Allocate the test vector */
    vector->vec_size  = vec_size;
    vector->op_vector = calloc(vec_size, sizeof(h5fl_arr_test_op));
    CHECK_PTR(vector->op_vector, "calloc");
    ...
    while (pos < (vec_size - num_active_tokens)) {
        ...
        /* (Also must have enough room for both alloc & free operations) */
        if (0 == num_active_tokens && pos < (vec_size - 2))
            op_code = get_new_h5fl_arr_op(h5fl_arr_empty_ops_odds);
        else {
            /* Don't create new tokens when there won't be enough room in the
             * vector for both the alloc & free operations.
             */
            if (pos > ((vec_size - num_active_tokens) - 2))
                op_code = get_new_h5fl_arr_op(h5fl_arr_vec_almost_full_ops_odds);
            /* Don't create new tokens when the token array is full */
            else if (num_tokens == num_active_tokens)
                op_code = get_new_h5fl_arr_op(h5fl_arr_full_ops_odds);
            else
                op_code = get_new_h5fl_arr_op(h5fl_arr_all_ops_odds);
        }
        ...
        switch (op_code) {
            ...
            case H5FL_ARR_OP_CALLOC: {
                ...
                type_idx  = (unsigned)h5_local_rand() % (unsigned)NELMTS(h5fl_arr_test_types);
                new_token = get_new_h5fl_arr_token(tokens, &curr_alloc_token);
                vector->op_vector[pos].token          = &tokens[new_token];
                vector->op_vector[pos].param.type_idx = type_idx;
    ...
    while (pos < vec_size) {
        ...
        /* Set op code */
        vector->op_vector[pos].op_code = H5FL_ARR_OP_FREE;
...
validate_h5fl_arr_token(const h5fl_arr_test_token *token)
{
    ...
    switch (token->state) {
        ...
        case H5FL_ARR_ST_ZERO:
            for (u = 0; u < token->curr_size; u++) {
                VERIFY(v[u], 0, "H5FL_ARR_ST_ZERO");
                if (0 != v[u])
                    return (1);
            }
            break;

        case H5FL_ARR_ST_FILL1:
            for (u = 0; u < token->curr_size; u++) {
                VERIFY(v[u], 1, "H5FL_ARR_ST_FILL1");
                if (1 != v[u])
                    return (1);
            }
            break;

        case H5FL_ARR_ST_FILL2:
            for (u = 0; u < token->curr_size; u++) {
                VERIFY(v[u], 2, "H5FL_ARR_ST_FILL2");
                if (2 != v[u])
                    return (1);
            }
            break;

        case H5FL_ARR_ST_FILL3:
            for (u = 0; u < token->curr_size; u++) {
                VERIFY(v[u], 3, "H5FL_ARR_ST_FILL3");
                if (3 != v[u])
                    return (1);
            }
            break;
...
static void
fill_h5fl_arr_vector(h5fl_arr_test_token *token)
{
    switch (token->state) {
        case H5FL_ARR_ST_UNINIT:
            break;
...
static unsigned
run_h5fl_arr_vector(h5fl_arr_test_vector *vector)
{
    /* Execute test vector */
    for (unsigned u = 0; u < vector->vec_size; u++) {
        switch (vector->op_vector[u].op_code) {
            case H5FL_ARR_OP_MALLOC:
                vector->op_vector[u].token->val =
                    H5FL_arr_malloc(h5fl_arr_test_types[vector->op_vector[u].param.type_idx].free_list,
                                    h5fl_arr_test_types[vector->op_vector[u].param.type_idx].max_size);
                CHECK_PTR(vector->op_vector[u].token->val, "H5FL_arr_malloc");
                if (NULL == vector->op_vector[u].token->val)
                    return (1);
                vector->op_vector[u].token->type_idx = vector->op_vector[u].param.type_idx;
                vector->op_vector[u].token->curr_size =
            ...
            case H5FL_ARR_OP_CALLOC:
                vector->op_vector[u].token->val =
                    H5FL_arr_calloc(h5fl_arr_test_types[vector->op_vector[u].param.type_idx].free_list,
                                    h5fl_arr_test_types[vector->op_vector[u].param.type_idx].max_size);
                CHECK_PTR(vector->op_vector[u].token->val, "H5FL_arr_calloc");
                if (NULL == vector->op_vector[u].token->val)
                    return (1);
                vector->op_vector[u].token->type_idx = vector->op_vector[u].param.type_idx;
                vector->op_vector[u].token->curr_size =
            ...
            case H5FL_ARR_OP_REALLOC: {
                ...
                if (H5FL_ARR_ST_UNINIT != vector->op_vector[u].token->state)
                    if (0 != validate_h5fl_arr_token(vector->op_vector[u].token))
                        return (1);

                /* Reallocate buffer */
                vector->op_vector[u].token->val =
                    H5FL_arr_realloc(h5fl_arr_test_types[vector->op_vector[u].token->type_idx].free_list,
                                     vector->op_vector[u].token->val, new_size);
                CHECK_PTR(vector->op_vector[u].token->val, "H5FL_arr_realloc");
                if (NULL == vector->op_vector[u].token->val)
                    return (1);
                ...
                vector->op_vector[u].token->curr_size = new_size;
                if (new_size > prev_size)
                    fill_h5fl_arr_vector(vector->op_vector[u].token);
            } break;
            ...
            case H5FL_ARR_OP_ZERO:
                if (H5FL_ARR_ST_UNINIT != vector->op_vector[u].token->state)
                    if (0 != validate_h5fl_arr_token(vector->op_vector[u].token))
                        return (1);
                if (H5FL_ARR_ST_ZERO != vector->op_vector[u].token->state) {
                    vector->op_vector[u].token->state = H5FL_ARR_ST_ZERO;
                    memset(vector->op_vector[u].token->val, 0, vector->op_vector[u].token->curr_size);
                }
                break;
            ...
            case H5FL_ARR_OP_FILL1:
                if (H5FL_ARR_ST_UNINIT != vector->op_vector[u].token->state)
                    if (0 != validate_h5fl_arr_token(vector->op_vector[u].token))
                        return (1);
                if (H5FL_ARR_ST_FILL1 != vector->op_vector[u].token->state) {
                    vector->op_vector[u].token->state = H5FL_ARR_ST_FILL1;
                    memset(vector->op_vector[u].token->val, 1, vector->op_vector[u].token->curr_size);
                }
                break;
            ...
            case H5FL_ARR_OP_FILL2:
                if (H5FL_ARR_ST_UNINIT != vector->op_vector[u].token->state)
                    if (0 != validate_h5fl_arr_token(vector->op_vector[u].token))
                        return (1);
                if (H5FL_ARR_ST_FILL2 != vector->op_vector[u].token->state) {
                    vector->op_vector[u].token->state = H5FL_ARR_ST_FILL2;
                    memset(vector->op_vector[u].token->val, 2, vector->op_vector[u].token->curr_size);
                }
                break;
            ...
            case H5FL_ARR_OP_FILL3:
                if (H5FL_ARR_ST_UNINIT != vector->op_vector[u].token->state)
                    if (0 != validate_h5fl_arr_token(vector->op_vector[u].token))
                        return (1);
                if (H5FL_ARR_ST_FILL3 != vector->op_vector[u].token->state) {
                    vector->op_vector[u].token->state = H5FL_ARR_ST_FILL3;
                    memset(vector->op_vector[u].token->val, 3, vector->op_vector[u].token->curr_size);
                }
                break;
            ...
            case H5FL_ARR_OP_FREE:
                if (H5FL_ARR_ST_UNINIT != vector->op_vector[u].token->state)
                    if (0 != validate_h5fl_arr_token(vector->op_vector[u].token))
                        return (1);
                H5FL_arr_free(h5fl_arr_test_types[vector->op_vector[u].token->type_idx].free_list,
                              vector->op_vector[u].token->val);
                vector->op_vector[u].token->val = NULL;
                break;
...
thread_h5fl_arr(void *_vectors)
{
    ...
    for (unsigned u = 0; u < NUM_ITERS_PER_THREAD; u++) {
        ...
        /* Run the test vector */
        errors += run_h5fl_arr_vector(&vectors[rng]);
    }
...
/* 'array' H5FL test vectors */
static h5fl_arr_test_vector *h5fl_arr_vectors[NUM_THREADS];

static void
test_h5fl_arr(void)
{
    h5fl_arr_test_token *tokens[NUM_THREADS]; /* Test tokens */
    H5TS_thread_t        threads[NUM_THREADS];
    herr_t               result;

    /* Output message about test being performed */
    MESSAGE(7, ("Testing 'array' H5FL operations\n"));

    /* Initialize the test vectors */
    for (unsigned u = 0; u < NUM_THREADS; u++) {
        /* Allocate the test tokens */
        tokens[u] = calloc(MAX_TOKENS, sizeof(h5fl_arr_test_token));
        CHECK_PTR(tokens[u], "calloc");

        /* Initialize the test vectors */
        h5fl_arr_vectors[u] = calloc(NUM_VECTORS, sizeof(h5fl_arr_test_vector));
        CHECK_PTR(h5fl_arr_vectors[u], "calloc");

        for (unsigned v = 0; v < NUM_VECTORS; v++)
            init_h5fl_arr_vector(NUM_TEST_OPS, &h5fl_arr_vectors[u][v], MAX_TOKENS, tokens[u]);
    }

    /* Create threads and have them execute the vector */
    for (unsigned u = 0; u < NUM_THREADS; u++) {
        result = H5TS_thread_create(&threads[u], thread_h5fl_arr, h5fl_arr_vectors[u]);
        CHECK_I(result, "H5TS_thread_create");
    }
    ...
    for (unsigned u = 0; u < NUM_THREADS; u++) {
        free(tokens[u]);
        for (unsigned v = 0; v < NUM_VECTORS; v++)
            free(h5fl_arr_vectors[u][v].op_vector);
        free(h5fl_arr_vectors[u]);
    }
}
